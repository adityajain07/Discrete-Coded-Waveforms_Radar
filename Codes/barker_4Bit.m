...
title('Binary 4-bit Phase-Coded Barker Code')
...
title('Matched Filter of Binary 4-Bit Barker Code')
...
title('Matched Filter of Binary 4-Bit Barker Code (log scale)')
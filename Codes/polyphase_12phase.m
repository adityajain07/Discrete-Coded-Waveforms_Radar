...
title('12-Phase Frank Code (Polyphase Code)')
...
title('Matched Filter of 12-Phase Frank Code')
...
title('Matched Filter of 12-Phase Frank Code (log scale)')
...
%%% Topic: Radar Systems Project; 31-bit PRN/MLS Code %%%
...
title('Matched Filter of 31-bit PRN Code')
...
title('Matched Filter of 31-bit PRN Code (log scale)')